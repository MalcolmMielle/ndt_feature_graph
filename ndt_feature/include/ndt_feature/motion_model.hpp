...
namespace ndt_feature {
	...
	typedef Eigen::Vector3d Pose2d;
     ...
     inline bool addStepPose2d(const ndt_feature::Pose2d &p1, const ndt_feature::Pose2d &p2, double maxDist, double maxRotation) {
	...
	inline ndt_feature::Pose2d pose2dFromAffine3d(const Eigen::Transform<double,3,Eigen::Affine,Eigen::ColMajor> &T) {
	Pose2d ret;
	...
	inline void pose2dClearDependence(ndt_feature::Pose2dCov &posecov) {
	posecov.cov(0,1) = 0.;
	posecov.cov(1,0) = 0.;
	posecov.cov(0,2) = 0.;
	posecov.cov(1,2) = 0.;
...
namespace boost {
  namespace serialization {
    ...
    void serialize(Archive& ar, ndt_feature::MotionModel2d::Params& o, const unsigned int version) {
      ar & o.Cd
        & o.Ct
        & o.Dd
        & o.Dt
